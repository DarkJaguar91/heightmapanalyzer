...
public class heightMapDisplay extends JPanel{
	/**
	 * Globals
	 */
	 ...
	 */
	public heightMapDisplay(Data.HeightMap map)
	{
		this.map = map;
	...
	/**
	 * Get the map (drawing components)
	 */
	...
	/**
	 * Changes the name for this height map
	 * @param name The new name for the height map
	 */
	...
	/**
	 * Gets the height maps name
	 * @return String of the maps name
	 */
